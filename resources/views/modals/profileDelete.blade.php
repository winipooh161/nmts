...
<div class="modal" id="profileDelete" style="display: none;">
    <div class="modal__body modal__flex__center profileDeleteMD">
        ...
        <div class="modal__form offlineModal">
            <form method="POST" action="{{ route('profileDelete') }}">
                @csrf
                <h6 class="tt">хоЧЕШЬ удалить <br>СВОЙ аккаунт?</h6>
                <p>Твой аккаунт будет удалён. <br> Автоматически будет выполнен выход из учётной записи.</p>
