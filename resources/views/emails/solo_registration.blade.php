...
<body>
    <div class="container">
        <p>Привет, {{ $name }}!</p>
        <p>Поздравляем с успешной регистрацией в дисциплине {{ $game->title }} на <a href="{{ url('/') }}">сайте</a> МТС Cyber Cup!</p>
        <p>С поиском команды тебе поможет Discord-канал, который уже создан на <a href="https://discord.gg/frQTgKfvQm">Discord-сервере</a>  турнира.</p>
